...
Ось готовий розділ для твоєї документації у файлі `README.md`. Я структурував його так само, як і попередні, з акцентом на механізмі обробки сигналів та роботі системних лімітів.
