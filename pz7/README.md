...
### 2.10. Задача 10: Генерація випадкових чисел з рухомою комою
**Опис:** Програма створює унікальні послідовності дробових чисел у заданих діапазонах. Вивід демонструє зміну послідовностей при різних параметрах, але код в матеріалах не наведено. Судячи з термінального виводу, програма обробляє аргументи (`./zd10 5.5`) і генерує числа в межах `[0; 1.0]` та `[0; n]`.
